...
public class SimpleSimilarity extends SimilarityBase {
   ...
   */
  public SimpleSimilarity(Independence independenceMeasure) {
  ...
  protected double score(BasicStats stats, double freq, double docLen) {
    ...
    //ORIGINAL: return stats.getBoost() * log2(measure + 1);
    return stats.getBoost() * Math.log(measure + 1) / Math.log(7);
  }
